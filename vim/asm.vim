...
syn match   armasmLocalLabel	"\d\{1,2\}[:fb]"
...
syn region	armasmComment	start="/\*" end="\*/" contains=@Spell,cTodo fold
...
""""""
" good job
syn keyword armasmDirective ABORT ALIGN ALTMACRO ASCII ASCIZ 
syn keyword armasmDirective BALIGN BALIGNL BALIGNW BYTE
syn keyword armasmDirective DATA DEF DESC DIM DOUBLE	
syn keyword armasmDirective	EJECT ELSE ELSEIF END ENDEF ENDFUNC ENDIF EQU 	
syn keyword armasmDirective	EQUIV EQV ERR ERROR EXITM EXTERN 
syn keyword armasmDirective FAIL FILE FILL FLOAT FUNC	
syn keyword armasmDirective GLOBAL GLOBL GNU_ATTRIBUTE
syn keyword armasmDirective HIDDEN HWORD 	
syn keyword armasmDirective	IDENT IF IFDEF IFNDEF INCBIN INCLUDE INT INTERNAL IRP IRPC
syn keyword armasmDirective LCOMM LFLAGS LINE LINKONCE LIST LN LOC	
syn keyword armasmDirective	LOC_MARK_LABELS LOCAL LONG
syn keyword armasmDirective	MACRO MRI NOALTMACRO NOLIST OCTA ORG	
syn keyword armasmDirective	P2ALIGN POPSECTION PREVIOUS PRINT PROTEXTED
syn keyword armasmDirective	PSIZE PURGEM PUSHSECTION QUAD 	
syn keyword armasmDirective	RELOC REPT SBTTL SCL SECTION SET SHORT SINGLE	
syn keyword armasmDirective	SIZE SKIP SLEB128 SPACE STABD STABN STABS	
syn keyword armasmDirective	STRING STRUCT SUBSECTION SYMVER  	
syn keyword armasmDirective	TAG TEXT TITLE TYPE 	
syn keyword armasmDirective	ULEB128
syn keyword armasmDirective	VAL VERSION VTABLE_ENTRY VTABLE_INHERIT	
syn keyword armasmDirective	WARNING WEAK WEAKREF WORD 
...
if version >= 508 || !exists("did_armasm_syntax_inits")
  ...
  """"""
  " Constant
  HiLink armasmString		Constant
  HiLink armasmASCII		Constant
  HiLink armasmBinary		Constant
  HiLink armasmDecimal		Constant
  HiLink armasmHexadecimal	Constant
  HiLink armasmOctal		Constant
  HiLink armasmBase3		Constant
  HiLink armasmBase4		Constant
  HiLink armasmBase5		Constant
  HiLink armasmBase6		Constant
  HiLink armasmBase7		Constant
  HiLink armasmBase9		Constant
  HiLink armasmFloat		Constant
  HiLink armasmBoolean		Constant
  " Builtin variables
  ...
  """"""
  " 
  HiLink armasmDirective	PreProc	
  HiLink armasmOpcode		Statement
  HiLink armasmRegister		Type
  HiLink armasmLabel		Special	
